...
- **The end of secure, multi-year funding.** Awards can be terminated at any time, year to year, whenever agency “priorities” shift ([§200.340](#s200-340); notice and appeal under [§200.341–.343](#s200-341)), and conditions can be added mid-award (§200.208). A grant can be cut within weeks or months of issuance — yet recipients must already hire staff, enroll students, and purchase equipment up front. That **shifts enormous financial exposure onto institutions and researchers** and makes any project that must span more than one year fundamentally insecure.
...
- **Politics over scientific merit.** Funding decisions shift from independent peer review to political appointees applying ideological tests ([§200.205](#s200-205)).
...
- **Harder to publish and disseminate results.** Publication and conference costs become unallowable or require case-by-case agency approval ([§200.461](#s200-461), [§200.432](#s200-432)).
- **Fewer opportunities for international collaboration.** Research awards default to U.S.-only entities and bar collaborations with “covered” foreign partners ([§200.202(e)](#s200-202e), [§200.220](#s200-220)).
- **More costs pushed onto institutions.** As routine research costs are made unallowable, universities must absorb the difference ([§200.461](#s200-461), [§200.432](#s200-432), [§200.219](#s200-219)).
...
| Parts 25, 170, 175 | critical | Carry the same **“guidance”→“regulation”** shift described in [the structural change above](#guidance-to-regulation) — the single biggest change in the rule. (Also: FSRS.gov references updated to SAM.gov.) |
